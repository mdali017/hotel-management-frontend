      ...
      >
        ...
        >
          <div className="flex justify-between">
            <h1 className="text-[#6EC1E4] text-3xl font-extrabold">{title}</h1>
            ...
            <div className="min-h-[200px]">
              <div className="pb-4 px-4 md:px-5 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    {showModal.itemData?.allImages?.map((image, idx) => (
                      <SwiperSlide key={idx}>
                          ...
                          <img
                            ...
                            src={
                              image.startsWith("http")
                                ? image
                                : `https://backend.hotelorioninternational.com/${image}`
                            }
                            alt=""
                          />
                        </div>
                ...
                <div className="h-full font-sans">
                  <p className="text-2xl font-bold text-green-700">
                    {showModal.itemData?.title}
                  </p>
                  <p className="text-md font-medium">
                    Package Type: {showModal.itemData?.package}
                  </p>
                  <p className="text-md font-medium">
                    Rate: {showModal.itemData?.price}++ Taka
                  </p>
